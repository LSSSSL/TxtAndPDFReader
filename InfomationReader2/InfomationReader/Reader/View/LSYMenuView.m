...
#define BottomViewHeight 160.0f
...
-(void)MenuViewChangeFileName:(NSString *)fileName BackColor:(UIColor *)backColor AlphaValue:(float)alphaValue
{
    [_topView TopMenuViewChangeFileName:fileName BackColor:backColor AlphaValue:alphaValue];
    [_bottomView BottomMenuViewChangeBackColor:backColor AlphaValue:alphaValue];
}
-(void)IsShowCatalogView:(BOOL)isShow
{
    [_bottomView BottomIsShowCatalogView:isShow];
}
