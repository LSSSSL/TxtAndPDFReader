...
-(LSYMenuView *)menuView
{
    if (!_menuView) {
        ...
        [_menuView MenuViewChangeFileName:self.fileName==nil?@"":self.fileName BackColor:self.backColor==nil?[UIColor blackColor]:self.backColor AlphaValue:self.alphaValue ==0.0f?1.0f:self.alphaValue];
        [_menuView IsShowCatalogView:(_model.chapters != nil && _model.chapters.count>0 && _model.chapters[0].title != nil)?YES:NO];
    }
    return _menuView;
}
