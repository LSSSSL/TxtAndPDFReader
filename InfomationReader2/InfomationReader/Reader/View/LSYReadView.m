...
-(void)drawDotWithLeft:(CGRect)Left right:(CGRect)right
{
    ...
    CGContextDrawImage(ctx,CGRectMake(CGRectGetMinX(Left)-dotSize/2, CGRectGetMaxY(Left)-dotSize/2, dotSize, dotSize),[UIImage imageWithContentsOfFile:[LSYReadUtilites getImagWithPath:@"r_drag-dot@2x.png"]].CGImage);
    CGContextDrawImage(ctx,CGRectMake(CGRectGetMaxX(right)-dotSize/2, CGRectGetMinY(right)-dotSize/2, dotSize, dotSize),[UIImage imageWithContentsOfFile:[LSYReadUtilites getImagWithPath:@"r_drag-dot@2x.png"]].CGImage);
}
#pragma mark - Privite Method
